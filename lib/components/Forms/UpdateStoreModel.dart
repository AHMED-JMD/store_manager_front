...
class _UpdateStoreState extends State<UpdateStore> {
  ...
  Widget build(BuildContext context) {
    return ElevatedButton.icon(
        ...
        style: ElevatedButton.styleFrom(
            backgroundColor: Colors.lightGreen, minimumSize: Size(250, 50)),
        icon: Icon(Icons.more_horiz,
            color: const Color.fromARGB(255, 39, 116, 44)),
        label: Text(
          'بيانات الصنف الاساسية',
          style: TextStyle(color: const Color.fromARGB(255, 236, 240, 237)),
        ));
  }
}
